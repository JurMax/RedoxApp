...
float Overture_WindowWidth = 1;
float Overture_WindowHeight = 1;
...
int initSDL() {
	...
	if (SDL_Init(SDL_INIT_VIDEO) < 0) {
		...
		rWindow = SDL_CreateWindow("SDL Tutorial", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, NULL, NULL,
...
void Overture_Start() {
	...
	while(isRunning) {
		...
		SDL_SetRenderDrawColor(rRenderer, clearColor.r, clearColor.g, clearColor.b, clearColor.a);
